...
# https://www.rdkit.org/docs/source/rdkit.Chem.rdchem.html. harvested all
# https://kimchangheon.tistory.com/m/41, 122 available
...
def calculate_property_short(smiles):
    RDLogger.DisableLog('rdApp.*')
    mol = Chem.MolFromSmiles(smiles)
    output=[]
